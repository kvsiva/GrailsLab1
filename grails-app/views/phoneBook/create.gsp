...
<html>
	...
	<body>
		<a href="#create-phoneBook" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-phoneBook" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:phoneBookInstance, action:'save']" >
				<fieldset class="form">
